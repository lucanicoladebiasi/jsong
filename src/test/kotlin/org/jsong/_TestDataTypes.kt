...
class _TestDataTypes {
    ...
    fun `Literal - array`() {
        ...
        val actual = _JSong.of("[\"value1\", \"value2\"]").evaluate()
    ...
    fun `Literal - false`() {
        ...
        val actual = _JSong.of("false").evaluate()
        assertEquals(expected, actual)
    }
    ...
    fun `Literal - null`() {
        ...
        val actual = _JSong.of("null").evaluate()
        assertEquals(expected, actual)
    }
    ...
    fun `Literal - number`() {
        ...
        val actual = _JSong.of("-12.35e+7").evaluate()
        assertEquals(expected, actual)
    }
    ...
    fun `Literal - object`() {
        ...
        val actual = _JSong.of("{\"key1\": \"value1\", \"key2\": \"value2\"}").evaluate()
        assertEquals(expected, actual)
    }

    @Test
    fun `Literal - range twisted`() {
        val expected = _RangeNode.of("2.718281828459".toBigDecimal(), "3.14159265359".toBigDecimal())
        val actual = _JSong.of("[3.14159265359..2.718281828459]").evaluate()
        assertEquals(expected, actual)
    }
    ...
    fun `Literal - range as array`()  {
        ...
        val actual = _JSong.of("[1..3]").evaluate()
        assertTrue(actual is _RangeNode)
    ...
    fun `Literal - range with gap`() {
        ...
        val actual = _JSong.of("[1..3, 5..7]").evaluate()
    ...
    fun `Literal - range with overlapping gap`() {
        ...
        val actual = _JSong.of("[1..3, 5..7, 2..4]").evaluate()
        assertTrue(actual is _RangesNode)
        assertEquals(expected, actual.indexes)
    }
    ...
    fun `Literal - text`() {
        ...
        val actual = _JSong.of(text).evaluate()
        assertEquals(expected, actual)
    }
    ...
    fun `Literal - true`() {
        ...
        val actual = _JSong.of("true").evaluate()
        assertEquals(expected, actual)
    }
